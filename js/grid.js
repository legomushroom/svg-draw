...
(function() {
  define('grid', ['path-finder', 'underscore'], function(PathFinder, _) {
    ...
    Grid = (function() {
      ...
      Grid.prototype.highlightCell = function(coords, type) {
        var $div, addition, i, j;
        ...
        j = coords.j;
        $div = $('<div/>');
        addition = this.normalizePortCoords(coords.coords, App.currTool === 'path' ? 1 : 2);
        $div.css({
          left: "" + (i * App.gs + addition.x) + "px",
          top: "" + (j * App.gs + addition.y) + "px"
        }).addClass("" + type + "-ghost");
        App.$main.append($div);
        return this.highLights["" + coords.i + coords.j] = $div;
      };

      Grid.prototype.normalizePortCoords = function(coords, size) {
        var sizeU, x, y;
      ...
      Grid.prototype.lowlightCell = function(coords) {
        if (this.highLights["" + coords.i + coords.j]) {
          this.highLights["" + coords.i + coords.j].remove();
